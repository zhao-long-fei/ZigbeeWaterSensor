...
def S37():
    ...
    if ("gcc" == "iar" or "gcc" == ""):
        ...
        GCC_TOOLCHAIN_PATH = shortPath(r"file:/C:/SiliconLabs/SimplicityStudio/v5/developer/toolchains/gnu_arm/7.2_2017q4/".replace(
            "file:", "").replace("%20", " "))
...
def EBL():
    ...
    EBL_COMMAND = START_FLAGS + shortPath(r"C:\SiliconLabs\SimplicityStudio\v5\developer\adapter_packs\commander\commander.exe").replace(
        " ", "\ ") + " ebl create " + EBL_FILE + " --app " + S37_BINARY + " --device EFR32MG21A020F512IM32 " + CONVERT_FLAGS
...
def GBL():
    ...
    GBL_COMMAND = START_FLAGS + shortPath(r"C:\SiliconLabs\SimplicityStudio\v5\developer\adapter_packs\commander\commander.exe").replace(
        " ", "\ ") + " gbl create " + GBL_FILE + " --app " + S37_BINARY + " --device EFR32MG21A020F512IM32"
