...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginCountersSendRequestCommandArguments[] = {
  "dest node id",
  "clear",
  NULL
};
...
static EmberCommandEntry emberCommandPluginCountersTable[] = {
  ...
  emberCommandEntryActionWithDetails("send-request", emberAfPluginCountersSendRequestCommand, "vu", "Sends a request for ota counters", pluginCountersSendRequestCommandArguments),
